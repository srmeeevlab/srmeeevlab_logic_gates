...
#### Step 7: In-order to verify the working of the circuit, try connecting an LED as an output device. As per the logic, the led will be red if the logical output is 1, and green if the logical output is 0. Click <a href="#">here</a> for a video demonstration.
